...
// Données pour le système de messagerie
  ...
  'conv_001': [
    {
      ...
      senderName: 'Vous',
      content: 'Bonjour, je suis intéressé par l\'iPhone 14 Pro Max. Est-il toujours disponible ?',
    ...
    },
    {
      ...
      content: 'Bonjour ! Oui, il est toujours disponible. C\'est un excellent téléphone en très bon état.',
    ...
    },
    {
      ...
      senderId: 'user_current',
      senderName: 'Vous',
      content: 'Parfait ! La batterie est en bon état ? Et la garantie est transférable ?',
    ...
    },
    {
      ...
      senderName: 'Tech Store Pro',
      senderAvatar: 'https://i.pravatar.cc/150?img=12',
      content: 'Batterie à 98% de santé, et oui la garantie Apple de 6 mois restante est transférable. Je peux vous faire une démonstration si vous voulez.',
      timestamp: '2026-02-06T10:37:00',
      read: true,
      type: 'text'
    },
    {
      ...
      senderId: 'user_current',
      senderName: 'Vous',
      content: 'Super ! Je peux passer demain vers 15h ?',
  ...
  'conv_002': [
    {
      ...
      senderId: 'user_current',
      senderName: 'Vous',
      content: 'Bonsoir, je voudrais commander votre thiéboudienne pour 4 personnes',
    ...
    },
    {
      ...
      content: 'Bonsoir ! Avec plaisir. Pour quelle heure souhaitez-vous la livraison ?',
    ...
    },
    {
      ...
      senderId: 'user_current',
      senderName: 'Vous',
      content: 'Ce serait pour demain midi, vers 12h30. Livraison à Plateau.',
      timestamp: '2026-02-05T18:08:00',
      read: true,
      type: 'text'
    },
    {
      ...
      senderName: 'Fatou Diop',
      senderAvatar: 'https://i.pravatar.cc/150?img=25',
      content: 'Parfait ! C\'est noté. 4 portions de thiéboudienne pour 12h30 à Plateau. Le total sera de 10 000 FCFA (2 500 x 4) + 1 500 FCFA de livraison = 11 500 FCFA.',
  ...
  'conv_003': [
    {
      ...
      senderId: 'user_current',
      senderName: 'Vous',
      content: 'Bonjour, je recherche un appartement F3 meublé pour 3 mois. Celui-ci est-il disponible à partir du 15 février ?',
    ...
    },
    {
      ...
      conversationId: 'conv_003',
      senderId: 'seller_003',
      senderName: 'Immobilier Premium',
      senderAvatar: 'https://i.pravatar.cc/150?img=33',
      content: 'Bonjour ! Malheureusement cet appartement sera libre à partir du 1er mars uniquement. Nous avons d\'autres options disponibles plus tôt si vous voulez.',
    ...
    },
    {
      ...
      senderId: 'user_current',
      senderName: 'Vous',
      content: 'D\'accord, je peux attendre jusqu\'au 1er mars. Que faut-il comme documents pour la réservation ?',
  ...
  'conv_004': [
    {
      ...
      senderId: 'seller_004',
      senderName: 'Auto Premium Dakar',
      senderAvatar: 'https://i.pravatar.cc/150?img=44',
      content: 'Bonjour ! Suite à votre demande sur la Toyota Corolla 2020, elle est toujours disponible. Voulez-vous planifier un essai ?',
...
export const mockConversations: Conversation[] = [
  {
    ...
    lastMessage: mockMessages['conv_001'][mockMessages['conv_001'].length - 1],
    unreadCount: 1,
  ...
  },
  {
    ...
    lastMessage: mockMessages['conv_002'][mockMessages['conv_002'].length - 1],
    unreadCount: 0,
    createdAt: '2026-02-05T18:00:00',
    updatedAt: '2026-02-05T18:10:00',
    status: 'active'
  },
  {
    id: 'conv_003',
    ...
    item: {
      id: 202,
      title: 'Appartement F3 meublé - Ngor',
      image: 'https://images.pexels.com/photos/584399/living-room-584399.jpeg',
      price: '350 000 FCFA/mois'
    },
    lastMessage: mockMessages['conv_003'][mockMessages['conv_003'].length - 1],
    unreadCount: 0,
    createdAt: '2026-02-04T09:15:00',
    updatedAt: '2026-02-04T14:30:00',
    status: 'active'
  },
  {
    id: 'conv_004',
    ...
    lastMessage: mockMessages['conv_004'][0],
    unreadCount: 1,
