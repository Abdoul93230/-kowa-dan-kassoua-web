...
export function FiltersSidebar({ 
  ...
  return (
    <div className={`bg-white ${isMobile ? 'p-4' : 'rounded-lg border border-slate-200 p-6'}`}>
      ...
      {/* Type de contenu */}
      <div className="mb-6">
        <Label className="text-sm font-semibold text-slate-900 mb-3 block">Type</Label>
      ...
      {/* Prix */}
      <div className="mb-6">
        <Label className="text-sm font-semibold text-slate-900 mb-3 block">Prix (FCFA)</Label>
      ...
      {/* Localisation */}
      <div className="mb-6">
        <Label className="text-sm font-semibold text-slate-900 mb-3 block">Localisation</Label>
        <Select 
      ...
      {filters.showProducts && (
        <div className="mb-6">
          <Label className="text-sm font-semibold text-slate-900 mb-3 block">État</Label>
          <div className="space-y-2">
            <label className="flex items-center gap-2 cursor-pointer">
              <input 
                type="radio" 
              ...
              />
              <span className="text-sm text-slate-700">Tous</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input 
                type="radio" 
      ...
      {/* Note minimale */}
      <div className="mb-6">
        <Label className="text-sm font-semibold text-slate-900 mb-3 block">Note minimale</Label>
        <div className="space-y-2">
          {[4, 3, 2, 1].map((rating) => (
            <label key={rating} className="flex items-center gap-2 cursor-pointer">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm text-slate-700 ml-1">& plus</span>
              </div>
            </label>
          ))}
        </div>
      ...
      <div className="mb-6">
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="text-sm text-slate-700">Offres en vedette uniquement</span>
        </label>
      </div>
